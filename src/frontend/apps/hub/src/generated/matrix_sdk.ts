  ...
  class FFIConverter extends AbstractFfiConverterByteArray<TypeName> {
    read(from: RustBuffer): TypeName {
      return {
        ...
        skipLobby: FfiConverterOptionalBoolean.read(from),
        header: FfiConverterOptionalTypeHeaderStyle.read(from),
        hideHeader: FfiConverterOptionalBoolean.read(from),
        preload: FfiConverterOptionalBoolean.read(from),
        appPrompt: FfiConverterOptionalBoolean.read(from),
        confineToRoom: FfiConverterOptionalBoolean.read(from),
        hideScreensharing: FfiConverterOptionalBoolean.read(from),
        controlledAudioDevices: FfiConverterOptionalBoolean.read(from),
    ...
    write(value: TypeName, into: RustBuffer): void {
      ...
      FfiConverterOptionalBoolean.write(value.skipLobby, into);
      FfiConverterOptionalTypeHeaderStyle.write(value.header, into);
      FfiConverterOptionalBoolean.write(value.hideHeader, into);
      FfiConverterOptionalBoolean.write(value.preload, into);
      FfiConverterOptionalBoolean.write(value.appPrompt, into);
      FfiConverterOptionalBoolean.write(value.confineToRoom, into);
      FfiConverterOptionalBoolean.write(value.hideScreensharing, into);
      FfiConverterOptionalBoolean.write(value.controlledAudioDevices, into);
...
export const EncryptionSystem = (() => {
  ...
  class SharedSecret_ extends UniffiEnum implements SharedSecret__interface {
    ...
    constructor(inner: { secret: string }) {
      super("EncryptionSystem", "SharedSecret");

      this.inner = Object.freeze(inner);
    }
    static new(inner: { secret: string }): SharedSecret_ {
...
export const PaginationStatus = (() => {
  ...
  class Idle_ extends UniffiEnum implements Idle__interface {
    ...
    constructor(inner: { hitTimelineStart: boolean }) {
      super("PaginationStatus", "Idle");

      this.inner = Object.freeze(inner);
    }
    static new(inner: { hitTimelineStart: boolean }): Idle_ {
...
export type PaginationStatus = InstanceType<
  (typeof PaginationStatus)["Idle" | "Paginating"]
>;
  ...
  implements OAuthAuthorizationDataLike
{
  ...
  static instanceOf(obj_: any): obj_ is OAuthAuthorizationData {
    return uniffiTypeOAuthAuthorizationDataObjectFactory.isConcreteType(obj_);
  }
}
...
const uniffiTypeOAuthAuthorizationDataObjectFactory: UniffiObjectFactory<OAuthAuthorizationDataLike> =
  (() => {
    ...
    const registry =
      typeof FinalizationRegistry !== "undefined"
        ? new FinalizationRegistry<UniffiHandle>((heldValue: UniffiHandle) => {
            uniffiTypeOAuthAuthorizationDataObjectFactory.freePointer(
              heldValue,
            );
          })
        : null;
    ...
    return {
      ...
      pointer(obj_: OAuthAuthorizationDataLike): UniffiHandle {
      ...
      clonePointer(obj_: OAuthAuthorizationDataLike): UniffiHandle {
      ...
      isConcreteType(obj_: any): obj_ is OAuthAuthorizationDataLike {
        return (
          obj_[destructorGuardSymbol] &&
          obj_[uniffiTypeNameSymbol] === "OAuthAuthorizationData"
        );
      },
    };
  })();
